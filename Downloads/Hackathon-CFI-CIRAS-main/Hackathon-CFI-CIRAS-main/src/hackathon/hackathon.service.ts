...
export class HackathonService {
  ...
  async getPublicHackathon() {
    try {
      ...
      if (!hackathon) {
        // Retourner null au lieu de lancer une exception pour éviter le 500
        return null;
      }
      ...
      console.error('Erreur lors de la récupération du hackathon public:', error);
      // En cas d'erreur de base de données, retourner null au lieu de planter
      return null;
    }
  }
  ...
  async getAvailableHackathons() {
    try {
      ...
      console.error('Erreur lors de la récupération des hackathons disponibles:', error);
